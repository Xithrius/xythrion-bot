...
def test_format_datetimes_in_dataframe() -> None:
    ...
    comparison_series = table["created_at"].ne(df["created_at"])  # pyright: ignore[reportUnknownVariableType]

    any_differences = bool(comparison_series.any())  # pyright: ignore[reportUnknownArgumentType]
